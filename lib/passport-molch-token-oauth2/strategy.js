 ...
 * @api public
 */
function MolchTokenStrategy(options, verify) {
  options = options || {}
  options.authorizationURL = options.authorizationURL || 'https://auth.molch.at/oauth2/authorize';
  options.tokenURL = options.tokenURL || 'https://auth.molch.at/oauth2/jwks';
  options.scopeSeparator = options.scopeSeparator || ',';

  this._passReqToCallback = options.passReqToCallback;

  OAuth2Strategy.call(this, options, verify);
  this.profileUrl = options.profileURL || 'https://auth.molch.at/oauth2/userinfo';
  this.name = 'molch-token';
}

/**
 * Inherit from `OAuth2Strategy`.
 */
util.inherits(MolchTokenStrategy, OAuth2Strategy);
 ...
 * @api protected
 */
MolchTokenStrategy.prototype.authenticate = function(req, options) {
  options = options || {};
  var self = this;
...
MolchTokenStrategy.prototype.authorizationParams = function(options) {
 ...
 * @api protected
 */
MolchTokenStrategy.prototype.userProfile = function(accessToken, done) {
 ...
 * @api private
 */
MolchTokenStrategy.prototype._loadUserProfile = function(accessToken, done) {
  var self = this;
 ...
 */
module.exports = MolchTokenStrategy;
